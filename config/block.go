...
// AddDirective adds a directive to the block
func (b *Block) AddDirective(directive IDirective) {
	b.Directives = append(b.Directives, directive)
}

// SetDirectives sets the directives in the block
func (b *Block) SetDirectives(directives []IDirective) {
